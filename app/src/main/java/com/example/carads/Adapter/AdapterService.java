...
import com.example.carads.Activity.PaymentCentre;
...
//    RelativeLayout container;
    public AdapterService(Activity activity, ArrayList<ModelService> r) {
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        final ModelService item = arrayList.get(position);
//        try {
...
//                Intent intent = new Intent(activity, PaymentCentre.class);
